...
(test test-diff-list
  ...
  (is (equalp
       (list 4 3 2 1)
       (bindle.diff-list::to-list (bindle.diff-list::d-cons 4 *d-list*))))

  (is (equalp
       (list 3 2 1 3 2 1)
       (bindle.diff-list::to-list (bindle.diff-list::d-append *d-list* *d-list*))))

  (is (equalp
       (list 3 2 1 0)
       (bindle.diff-list::to-list (bindle.diff-list::d-snoc *d-list* 0)))))
